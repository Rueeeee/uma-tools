...
- [点击进入](https://Rueeeee.github.io/UmaE/)
- 用于模拟不同赛道条件下的比赛过程，技能分布
- 源代码： [Rueeeee/UmaE: 砂井模拟器的闪耀优俊少女特供版本](https://github.com/Rueeeee/UmaE)
...
- [点击进入](https://Rueeeee.github.io/uma-tools/)
- 根据比赛数据计算并生成身位表
- 源代码： [Rueeeee/uma-tools: uma-skills-tools的闪耀优俊少女特供版本](https://github.com/Rueeeee/uma-tools)
